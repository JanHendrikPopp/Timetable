...
public class CenturyDAO {
	 ...
	 * 
	 * @param century
	 *            The century to persist. The given entity can be transient or
	 *            detached.
	 */
	 ...
	 * @param id
	 *            The identifier.
	 * @return a century or null if no century was found with the given
	 *         identifier.
	 */
	public Century load(Long id) {
		return (Century) sessionFactory.getCurrentSession().get(Century.class,
				id);
	}
	...
	public List<Century> loadAll() {
		return sessionFactory.getCurrentSession().createQuery("from Century")
				.list();
	}
